      ...
      <section>
        <Carousel style={{ maxHeight: "600px", overflow: "hidden" }}>
          ...
          <Carousel.Item interval={500}>
            <img className="d-block w-100" src="/cow3.jpg" alt="Second slide" />
          </Carousel.Item>
          <Carousel.Item interval={500}>
            <img
              // style={{ height: '50%', width: '50%', objectFit: 'cover' }}
      ...
      <All>
        <section className="vendor" id="vendor">
          ...
          <div className="box-container">
            ...
            <div className="box">
              <img
                src="https://www.petplace.com/static/c76c42473b20bbd7fd3113366e412a3e/c23ac/shutterstock_1048123303.jpg"
                alt=""
              />
              <div className="info">
